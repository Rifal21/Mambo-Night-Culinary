                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($tenant as $item)
                        <div class="bg-white rounded-lg shadow p-3">
                            ...
                            <hr class="text-sm text-gray-200">
                            </hr>
                            ...
                            <div class="flex flex-wrap gap-1">
                                <a href="https://www.instagram.com/{{ $item->ig }}" target="_blank"
                                    class="flex items-center space-x-1 text-gray-600 mt-2">
                                    <i class="fab fa-instagram"></i>
                                    <span class="text-sm font-semibold">{{ $item->ig }}</span>
                                </a>
                                <a href="https://www.tiktok.com/@{{ $item - > tt }}" target="_blank"
                                    class="flex items-center space-x-1 text-gray-600 mt-2">
                                    ...
                                    <span class="text-sm font-semibold">{{ $item->tt }}</span>
                                </a>
                            </div>
                            <div class="flex flex-col">
                                <a href="#" target="_blank"
                                    class="flex items-center space-x-1 text-gray-600 mt-2 text-sm font-semibold">
                                    GoFood :
                                    <span class="text-sm font-semibold pl-2">{{ $item->gofood }}</span>
                                </a>
                                <a href="#" target="_blank"
                                    class="flex items-center space-x-1 text-gray-600 mt-2 text-sm font-semibold">
                                    GrabFood :
                                    <span class="text-sm font-semibold pl-2">{{ $item->grabfood }}</span>
                                </a>
                            </div>

...
@section('container')
                ...
                <li
                    ...
                    <div class="flex space-x-6">
                        <button class="text-blue-500 hover:text-blue-600"
                            onclick="openModalUpdate({{ json_encode($item) }})">
                            <i class="fas fa-pen"></i>
                        </button>
                        <button class="text-yellow-500 hover:text-yellow-600"
                            onclick="openModalView({{ json_encode($item) }})">
    ...
    <div id="modal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center hidden">
        <div class="bg-white rounded-lg shadow-lg w-80 max-h-[70vh] p-6 relative overflow-hidden">
        ...
        <div class="bg-white rounded-lg shadow-lg w-80 p-6 relative">
            ...
            <div class="overflow-y-auto no-scrollbar h-[320px]">
                <form action="" method="POST" enctype="multipart/form-data" id="updateForm">
                    ...
                    <label class="block text-gray-700 mb-2">Gambar</label>
                    <input type="file" name="gambar" id="updateGambar"
